...
Ball.prototype.initDOM=function() {
  ...
  ball.style.width=this.r * 2.2+"px";
  ball.style.height=this.r * 1.2+"px";
...
function pauseButtons() {
  for (let i=0; i < balls.length; i++) {
    ...
    if (animating===false) {
      ball.speed=options.ballBaseSpeed+Math.floor(Math.random() * options.ballVariantSpeed);
...
function consoleMessage() {
  ...
  setInterval(function() {
      ...
      console.log("%cWe are so sorry", `color: $ {
          colors[num]
        }
