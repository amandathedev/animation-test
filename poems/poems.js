...
let iml = new Poem(
  "https://www.poetryfoundation.org/poems/150097/immediately-motionless-likeness"
);
let sun = new Poem(
  "https://hyperallergic.com/469850/two-poems-by-kirsten-ihns/"
);
let itc = new Poem("https://yr.olemiss.edu/piece/ihns-2/");
let btg = new Poem(
  "http://dreginald.com/index.php/issues/issue-fourteen/kirsten-ihns"
);
let witb = new Poem("http://www.jubilat.org/jubilat/archive/issue36/");
let bwr = new Poem(
  "https://bwr.ua.edu/2016-contest-an-interview-with-poetry-winner-kirsten-ihns/"
);
...
let adoh = new Poem(
  "http://blacksunlit.com/2019/06/three-poems-by-kirsten-ihns/"
);
let rts = new Poem(
  "https://issuu.com/phoebejournal/docs/phoebe_48.2_final_pdf_fc4535b24c1a59/101"
);
...
let te = new Poem(
  "https://iowareview.org/blog/trash-exoticaroissy-mcdonaldsred-orangeradiant-orchid"
);
...
let mrerh = new Poem("https://flagandvoid.com/ihns/")
